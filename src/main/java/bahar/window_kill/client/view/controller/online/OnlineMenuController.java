...
public class OnlineMenuController {
    ...
    public void onNewSquad(ActionEvent actionEvent) {
        GeneralAnswer generalAnswer = new TCPClient().newSquad(GameController.user.getUsername(), newSquadName.getText());
    ...
    public void onNewGame(ActionEvent actionEvent) {
        new TCPClient().sendGameRequest(true, GameController.user.getUsername(), "");
