module learningJavaFX {
    ...
    exports bahar.window_kill.client.control.states.offlline.processors;
    exports bahar.window_kill.client.control.states;
    exports bahar.window_kill.client.control.util;
    opens bahar.window_kill.client.control.states.offlline.processors.abilities to com.google.gson;
    opens bahar.window_kill.communications.messages.client to com.google.gson;
    opens bahar.window_kill.client.control.states.offlline.processors.abilities.skills to com.google.gson;
    opens bahar.window_kill.communications.messages.server to com.google.gson;
    exports bahar.window_kill.client.control.states.offlline.processors.abilities.skills to com.google.gson;
    exports bahar.window_kill.client.control.states.offlline.processors.spawners;
    ...
    exports bahar.window_kill.client.control.states.offlline.processors.abilities to com.google.gson;
